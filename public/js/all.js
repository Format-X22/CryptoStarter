...
Opal.modules["util/UtilsPack"] = function(Opal) {
  ...
  Opal.add_stubs(['$html=', '$[]', '$modal', '$call', '$*', '$on', '$valid_marker', '$to_proc', '$unmark_invalid', '$mark_invalid', '$attr', '$===', '$add_class', '$parent', '$remove_class', '$children', '$insert', '$<<', '$Native']);
  return (function($base) {
    ...
    Opal.defn(self, '$valid_marker', TMP_5 = function $$valid_marker(target) {
      ...
      if ((($a = cond.$call()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return self.$unmark_invalid(target)
        } else {
        return self.$mark_invalid(target)
      };
    }, TMP_5.$$arity = 1);
    ...
    Opal.defn(self, '$js_new', TMP_8 = function $$js_new(func, $a_rest) {
      var self = this, args, $iter = TMP_8.$$p, block = $iter || nil;
...
Opal.modules["page/LoginPage"] = function(Opal) {
  ...
  Opal.add_stubs(['$map_elements', '$make_handlers', '$[]', '$on', '$email_valid', '$pass_valid', '$send_login_request', '$valid_marker', '$===', '$length', '$value']);
  return (function($base, $super) {
    function $LoginPage(){};
    var self = $LoginPage = $klass($base, $super, 'LoginPage', $LoginPage);

    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_4, TMP_6, TMP_8, TMP_9;
    ...
    Opal.defn(self, '$make_handlers', TMP_4 = function $$make_handlers() {
      ...
      if ((($c = ($d = self.$email_valid(), $d !== false && $d !== nil && $d != null ?self.$pass_valid() : $d)) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
          return self.$send_login_request()
          } else {
          return nil
    ...
    return (Opal.defn(self, '$send_login_request', TMP_9 = function $$send_login_request() {
      var self = this;

      return nil;
    }, TMP_9.$$arity = 0), nil) && 'send_login_request';
  })($scope.base, $scope.get('AbstractPage'))
};
...
Opal.modules["page/RegisterPage"] = function(Opal) {
  ...
  Opal.add_stubs(['$map_elements', '$make_handlers', '$[]', '$on', '$email_valid', '$pass_valid', '$term_valid', '$valid_marker', '$===', '$length', '$value', '$==', '$is']);
  return (function($base, $super) {
    function $RegisterPage(){};
    var self = $RegisterPage = $klass($base, $super, 'RegisterPage', $RegisterPage);

    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_4, TMP_6, TMP_9, TMP_11, TMP_12;
    ...
    return (Opal.defn(self, '$send_login_request', TMP_12 = function $$send_login_request() {
      var self = this;

      return nil;
    }, TMP_12.$$arity = 0), nil) && 'send_login_request';
  })($scope.base, $scope.get('AbstractPage'))
};
