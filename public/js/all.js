...
/* Generated by Opal 0.10.5 */
Opal.modules["Landing"] = function(Opal) {
  function $rb_lt(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs < rhs : lhs['$<'](rhs);
  }
  function $rb_gt(lhs, rhs) {
  ...
  return (function($base, $super) {
    ...
    Opal.defn(self, '$map_elements', TMP_3 = function $$map_elements() {
      ...
      self.register_modal = e['$[]']("#register-modal");
      self.ico_confirm = e['$[]']("#ico-confirm");
      self.ico_data = e['$[]']("#ico-data");
      return self.no_usa = e['$[]']("#no-usa");
    }, TMP_3.$$arity = 0);

    Opal.defn(self, '$expose_plugins', TMP_4 = function $$expose_plugins() {
      var self = this;

      $scope.get('Element').$expose("modal");
...
if (request == null) request = nil;
    ...
    Opal.defn(self, '$handle_registration', TMP_15 = function $$handle_registration(request) {
      ...
      if ((($a = ($b = request['$ok?'](), $b !== false && $b !== nil && $b != null ?request.$json()['$[]']("success") : $b)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return self.register_modal.$modal()
        } else {
...
(function(Opal) {
  ...
  $scope.get('ConsoleSurprise').$new();
    return $scope.get('Landing').$new();}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b);
})(Opal);
