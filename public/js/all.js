...
Opal.modules["util/UtilsPack"] = function(Opal) {
  ...
  Opal.add_stubs(['$html=', '$[]', '$modal', '$call', '$*', '$on', '$unmark_invalid', '$mark_invalid', '$remove_class', '$children', '$add_class', '$parent', '$insert', '$<<', '$Native']);
  return (function($base) {
    ...
    Opal.defn(self, '$valid_tracker', TMP_3 = function $$valid_tracker(target, event) {
      ...
      TMP_3.$$p = null;
      return ($a = ($b = target).$on, $a.$$p = (TMP_4 = function(){var self = TMP_4.$$s || this, $c;

      if ((($c = cond.$call()) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
          return self.$unmark_invalid(target)
          } else {
          return self.$mark_invalid(target)
        }}, TMP_4.$$s = self, TMP_4.$$arity = 0, TMP_4), $a).call($b, event);
    }, TMP_3.$$arity = 2);

    Opal.defn(self, '$mark_invalid', TMP_5 = function $$mark_invalid(target) {
      var self = this;

      return target.$parent(".form-group").$add_class("has-error").$add_class("has-feedback").$children(".form-control-feedback").$remove_class("hidden");
    }, TMP_5.$$arity = 1);

    Opal.defn(self, '$unmark_invalid', TMP_6 = function $$unmark_invalid(target) {
      var self = this;

      return target.$parent(".form-group").$remove_class("has-error").$remove_class("has-feedback").$children(".form-control-feedback").$add_class("hidden");
    }, TMP_6.$$arity = 1);

    Opal.defn(self, '$js_new', TMP_7 = function $$js_new(func, $a_rest) {
      var self = this, args, $iter = TMP_7.$$p, block = $iter || nil;
...
/* Generated by Opal 0.10.5 */
Opal.modules["page/AboutPage"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  return (function($base, $super) {
    function $AboutPage(){};
    var self = $AboutPage = $klass($base, $super, 'AboutPage', $AboutPage);
...
/* Generated by Opal 0.10.5 */
Opal.modules["page/Error404Page"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  return (function($base, $super) {
    function $Error404Page(){};
    var self = $Error404Page = $klass($base, $super, 'Error404Page', $Error404Page);
...
(function(Opal) {
  ...
  self.$require("page/AboutPage");
  self.$require("page/Error404Page");
  ...
  $scope.get('ConsoleSurprise').$new();
    ...
    return (function() {$case = $gvars.$['$[]']("location").$pathname();if (/^\//['$===']($case)) {return $scope.get('IndexPage').$new()}else if (/^\/about/['$===']($case)) {return $scope.get('AboutPage').$new()}else if (/^\/login/['$===']($case)) {return $scope.get('LoginPage').$new()}else if (/^\/profile/['$===']($case)) {return $scope.get('ProfilePage').$new()}else if (/^\/project/['$===']($case)) {return $scope.get('ProjectPage').$new()}else if (/^\/registerProject/['$===']($case)) {return $scope.get('RegisterProjectPage').$new()}else if (/^\/register/['$===']($case)) {return $scope.get('RegisterPage').$new()}else if (/^\/restorePass/['$===']($case)) {return $scope.get('RestorePassPage').$new()}else if (/^\/term/['$===']($case)) {return nil}else {return $scope.get('Error404Page').$new()}})();}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b);
})(Opal);
