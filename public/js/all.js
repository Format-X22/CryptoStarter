...
Opal.modules["page/AllPages"] = function(Opal) {
  ...
  Opal.add_stubs(['$map_elements', '$expose_plugins', '$init_scroll_to_top', '$[]', '$expose', '$on', '$<', '$width', '$effect', '$remove_class', '$>', '$scroll_top', '$animate']);
  return (function($base, $super) {
    function $AllPages(){};
    ...
    return (Opal.defn(self, '$init_scroll_to_top', TMP_6 = function $$init_scroll_to_top() {
      ...
      if ((($c = $rb_lt(self.body_and_html.$width(), 767)) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
          self.to_top.$effect("fade_out")};
...
Opal.modules["page/IndexPage"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    Opal.defn(self, '$map_elements', TMP_3 = function $$map_elements() {
      ...
      self.done_projects = e['$[]']("#done-projects");
      return self.project_tabs_btns = e['$[]']("#project-tabs a");
    }, TMP_3.$$arity = 0);
  ...
  return (function($base, $super) {
    ...
    Opal.defn(self, '$try_login', TMP_7 = function $$try_login() {
      ...
      if ((($a = ($b = self.$email_valid(), $b !== false && $b !== nil && $b != null ?self.$pass_valid() : $b)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        ...
        return (($c = ["/profile"]), $d = $gvars.$.$location(), $d['$href='].apply($d, $c), $c[$c.length-1])}, TMP_6.$$s = self, TMP_6.$$arity = 0, TMP_6), $a).call($b, $hash2(["action", "email", "pass"], {"action": "login", "email": self.email.$value(), "pass": self.pass.$value()}))
        } else {
        return nil
      };
    }, TMP_7.$$arity = 0);
  ...
  return (function($base, $super) {
    ...
    Opal.defn(self, '$try_register', TMP_7 = function $$try_register() {
      ...
      if ((($a = ($b = ($c = self.$email_valid(), $c !== false && $c !== nil && $c != null ?self.$pass_valid() : $c), $b !== false && $b !== nil && $b != null ?self.$term_valid() : $b)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        ...
        return (($d = ["/profile"]), $e = $gvars.$.$location(), $e['$href='].apply($e, $d), $d[$d.length-1])}, TMP_6.$$s = self, TMP_6.$$arity = 0, TMP_6), $a).call($b, $hash2(["action", "email", "pass"], {"action": "register", "email": self.email.$value(), "pass": self.pass.$value()}))
        } else {
        return nil
      };
    }, TMP_7.$$arity = 0);
  ...
  return (function($base, $super) {
    ...
    Opal.defn(self, '$try_register', TMP_7 = function $$try_register() {
      ...
      if ((($a = ($b = ($c = ($d = ($e = self.$name_valid(), $e !== false && $e !== nil && $e != null ?self.$short_valid() : $e), $d !== false && $d !== nil && $d != null ?self.$email_valid() : $d), $c !== false && $c !== nil && $c != null ?self.$pass_valid() : $c), $b !== false && $b !== nil && $b != null ?self.$term_valid() : $b)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        ...
        return (($f = ["/projectConstructor"]), $g = $gvars.$.$location(), $g['$href='].apply($g, $f), $f[$f.length-1])}, TMP_6.$$s = self, TMP_6.$$arity = 0, TMP_6), $a).call($b, $hash2(["action", "name", "short", "email", "pass"], {"action": "registerProject", "name": self.name.$value(), "short": self["short"].$value(), "email": self.email.$value(), "pass": self.pass.$value()}))
        } else {
        return nil
      };
    }, TMP_7.$$arity = 0);
