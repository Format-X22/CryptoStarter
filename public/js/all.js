...
Opal.modules["page/ProfilePage"] = function(Opal) {
  ...
  Opal.add_stubs(['$map_elements', '$make_handlers', '$[]', '$on', '$has_class?', '$remove_class', '$add_class', '$href=', '$location', '$id', '$current_target', '$last', '$split']);
  return (function($base, $super) {
    function $ProfilePage(){};
    var self = $ProfilePage = $klass($base, $super, 'ProfilePage', $ProfilePage);

    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_7;

    def.edit_profile_btn = def.edit_security_btn = def.create_project_btn = def.edit_projects_btns = nil;
    Opal.defn(self, '$initialize', TMP_1 = function $$initialize() {
      var self = this;
    ...
    Opal.defn(self, '$map_elements', TMP_2 = function $$map_elements() {
      ...
      return self.edit_projects_btns = e['$[]']("#projects-table .cs-edit");
    }, TMP_2.$$arity = 0);

    return (Opal.defn(self, '$make_handlers', TMP_7 = function $$make_handlers() {
      ...
      if ((($c = self.edit_profile_form['$has_class?']("hidden")) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
        ...
        return self.edit_security_form.$add_class("hidden");}, TMP_3.$$s = self, TMP_3.$$arity = 0, TMP_3), $a).call($b, "click");
      ...
      if ((($d = self.edit_security_form['$has_class?']("hidden")) !== nil && $d != null && (!$d.$$is_boolean || $d == true))) {
        ...
        return self.edit_profile_form.$add_class("hidden");}, TMP_4.$$s = self, TMP_4.$$arity = 0, TMP_4), $a).call($c, "click");
      ...
      return ($a = ($e = self.edit_projects_btns).$on, $a.$$p = (TMP_6 = function(event){var self = TMP_6.$$s || this, $f, $g, full_id = nil, id = nil;
        if ($gvars.$ == null) $gvars.$ = nil;
if (event == null) event = nil;
    ...
    }, TMP_7.$$arity = 0), nil) && 'make_handlers';
  })($scope.base, $scope.get('AbstractPage'))
};
