...
/* Generated by Opal 0.10.5 */
Opal.modules["UtilsPack"] = function(Opal) {
  function $rb_times(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs * rhs : lhs['$*'](rhs);
  }
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $gvars = Opal.gvars;
...
/* Generated by Opal 0.10.5 */
Opal.modules["AllPages"] = function(Opal) {
  function $rb_lt(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs < rhs : lhs['$<'](rhs);
  }
  function $rb_gt(lhs, rhs) {
  ...
  Opal.add_stubs(['$require', '$include', '$map_elements', '$expose_plugins', '$init_scroll_to_top', '$[]', '$expose', '$on', '$<', '$width', '$effect', '$remove_class', '$>', '$scroll_top', '$animate']);
...
/* Generated by Opal 0.10.5 */
Opal.modules["ConsoleSurprise"] = function(Opal) {
  function $rb_plus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs + rhs : lhs['$+'](rhs);
  }
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $gvars = Opal.gvars;
...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$ready?', '$new', '$pathname', '$[]', '$===', '$p']);
  self.$require("opal");
  self.$require("native");
  self.$require("opal-jquery");
  self.$require("AllPages");
  self.$require("RootPage");
  self.$require("ConsoleSurprise");
  ...
  $scope.get('ConsoleSurprise').$new();
    ...
    return (function() {$case = $gvars.$['$[]']("location").$pathname();if ("/"['$===']($case)) {self.$p(1);
    return $scope.get('RootPage').$new();}else { return nil }})();}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b);
})(Opal);
