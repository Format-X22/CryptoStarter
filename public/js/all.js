...
/* Generated by Opal 0.10.5 */
Opal.modules["util/UtilsPack"] = function(Opal) {
  function $rb_times(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs * rhs : lhs['$*'](rhs);
  }
  ...
  return (function($base) {
    ...
    Opal.defn(self, '$show_error', TMP_1 = function $$show_error(text) {
      ...
      (($a = [text]), $b = $scope.get('Element')['$[]']("#error-modal-body"), $b['$html='].apply($b, $a), $a[$a.length-1]);
      return $scope.get('Element')['$[]']("#error-modal").$modal();
    }, TMP_1.$$arity = 1);

    Opal.defn(self, '$after', TMP_2 = function $$after(delay) {
      var self = this, $iter = TMP_2.$$p, block = $iter || nil;
      if ($gvars.$ == null) $gvars.$ = nil;

      TMP_2.$$p = null;
      return $gvars.$['$[]']("setTimeout").$call(block, $rb_times(delay, 1000));
    }, TMP_2.$$arity = 1);

    Opal.defn(self, '$valid_tracker', TMP_3 = function $$valid_tracker(target, event) {
      var $a, $b, TMP_4, self = this, $iter = TMP_3.$$p, cond = $iter || nil;

      TMP_3.$$p = null;
      return ($a = ($b = target).$on, $a.$$p = (TMP_4 = function(){var self = TMP_4.$$s || this, $c, $d;

      return ($c = ($d = self).$valid_marker, $c.$$p = cond.$to_proc(), $c).call($d, target)}, TMP_4.$$s = self, TMP_4.$$arity = 0, TMP_4), $a).call($b, event);
    }, TMP_3.$$arity = 2);

    Opal.defn(self, '$valid_marker', TMP_5 = function $$valid_marker(target) {
      var $a, self = this, $iter = TMP_5.$$p, cond = $iter || nil;

      TMP_5.$$p = null;
      if ((($a = cond.$call()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        self.$unmark_invalid(target);
        return true;
        } else {
        self.$mark_invalid(target);
        return false;
      };
    }, TMP_5.$$arity = 1);

    Opal.defn(self, '$mark_invalid', TMP_6 = function $$mark_invalid(target) {
      var self = this, $case = nil;

      return (function() {$case = target.$attr("type");if ("checkbox"['$===']($case)) {return target.$parent("label").$parent(".checkbox").$add_class("has-error")}else {return target.$parent(".form-group").$add_class("has-error").$add_class("has-feedback").$children(".form-control-feedback").$remove_class("hidden")}})();
    }, TMP_6.$$arity = 1);

    Opal.defn(self, '$unmark_invalid', TMP_7 = function $$unmark_invalid(target) {
      var self = this, $case = nil;
...
if (event == null) event = nil;
    ...
    Opal.defn(self, '$call_api', TMP_11 = function $$call_api(point, payload) {
...
if (request == null) request = nil;
      if ((($c = ($d = request['$ok?'](), $d !== false && $d !== nil && $d != null ?request.$json()['$[]']("success") : $d)) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
        ...
        }}, TMP_12.$$s = self, TMP_12.$$arity = 1, TMP_12), $a).call($b, "/api/" + (point), $hash2(["payload"], {"payload": payload}));
    }, TMP_11.$$arity = 2);
...
/* Generated by Opal 0.10.5 */
Opal.modules["page/AbstractPage"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  Opal.add_stubs(['$include']);
  self.$require("page/AbstractPage"+ '/../' + "../util/UtilsPack");
  return (function($base, $super) {
    function $AbstractPage(){};
    var self = $AbstractPage = $klass($base, $super, 'AbstractPage', $AbstractPage);

    var def = self.$$proto, $scope = self.$$scope;

    return self.$include($scope.get('UtilsPack'))
  })($scope.base, null);
};

/* Generated by Opal 0.10.5 */
Opal.modules["page/AllPages"] = function(Opal) {
  function $rb_gt(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs > rhs : lhs['$>'](rhs);
  }
  ...
  return (function($base, $super) {
    ...
    Opal.defn(self, '$map_elements', TMP_2 = function $$map_elements() {
      var self = this, e = nil;
...
if (event == null) event = nil;
    ...
    Opal.defn(self, '$init_scroll_to_top', TMP_8 = function $$init_scroll_to_top() {
      ...
      self.to_top.$remove_class("hidden");
        if ((($c = $rb_gt(self.js_window.$scroll_top(), $scope.get('TO_TOP_EDGE'))) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
...
/* Generated by Opal 0.10.5 */
Opal.modules["page/IndexPage"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$map_elements', '$expose_plugins', '$init_tabs', '$after', '$init_slider', '$[]', '$expose', '$each', '$remove_class', '$to_n', '$revolution', '$show', '$hide']);
  return (function($base, $super) {
    function $IndexPage(){};
    var self = $IndexPage = $klass($base, $super, 'IndexPage', $IndexPage);
    ...
    Opal.defn(self, '$map_elements', TMP_3 = function $$map_elements() {
      var self = this, e = nil;

      e = $scope.get('Element');
      self.slider = e['$[]']("#wow-slider");
      self.slider_loader = e['$[]']("#wow-fix-loader");
      self.active_projects = e['$[]']("#active-projects");
      self.prepared_projects = e['$[]']("#prepared-projects");
      return self.done_projects = e['$[]']("#done-projects");
    }, TMP_3.$$arity = 0);

    Opal.defn(self, '$expose_plugins', TMP_4 = function $$expose_plugins() {
      var self = this;

      $scope.get('Element').$expose("revolution");
...
Opal.modules["page/LoginPage"] = function(Opal) {
  ...
  Opal.add_stubs(['$map_elements', '$make_handlers', '$[]', '$on_enter_key', '$try_login', '$on', '$email_valid', '$pass_valid', '$call_api', '$href=', '$location', '$value', '$valid_marker', '$===', '$length']);
  return (function($base, $super) {
    function $LoginPage(){};
    ...
    Opal.defn(self, '$try_login', TMP_7 = function $$try_login() {
      var $a, $b, TMP_6, self = this;

      if ((($a = ($b = self.$email_valid(), $b !== false && $b !== nil && $b != null ?self.$pass_valid() : $b)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return ($a = ($b = self).$call_api, $a.$$p = (TMP_6 = function(){var self = TMP_6.$$s || this, $c, $d;
          if ($gvars.$ == null) $gvars.$ = nil;

        return (($c = ["/profile-self"]), $d = $gvars.$.$location(), $d['$href='].apply($d, $c), $c[$c.length-1])}, TMP_6.$$s = self, TMP_6.$$arity = 0, TMP_6), $a).call($b, "login", $hash2(["email", "pass"], {"email": self.email.$value(), "pass": self.pass.$value()}))
        } else {
        return nil
      };
    }, TMP_7.$$arity = 0);

    Opal.defn(self, '$email_valid', TMP_9 = function $$email_valid() {
      var $a, $b, TMP_8, self = this;

      return ($a = ($b = self).$valid_marker, $a.$$p = (TMP_8 = function(){var self = TMP_8.$$s || this, $c;
        if (self.email == null) self.email = nil;

      return ($c = ($range(5, 150, false))['$==='](self.email.$value().$length()), $c !== false && $c !== nil && $c != null ?/.+@.+\..+/['$==='](self.email.$value()) : $c)}, TMP_8.$$s = self, TMP_8.$$arity = 0, TMP_8), $a).call($b, self.email);
    }, TMP_9.$$arity = 0);

    return (Opal.defn(self, '$pass_valid', TMP_11 = function $$pass_valid() {
      ...
      return ($range(8, 150, false))['$==='](self.pass.$value().$length())}, TMP_10.$$s = self, TMP_10.$$arity = 0, TMP_10), $a).call($b, self.pass);
    }, TMP_11.$$arity = 0), nil) && 'pass_valid';
  })($scope.base, $scope.get('AbstractPage'))
};

/* Generated by Opal 0.10.5 */
Opal.modules["page/ProfilePage"] = function(Opal) {
  function $rb_minus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs - rhs : lhs['$-'](rhs);
  }
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $gvars = Opal.gvars, $hash2 = Opal.hash2;

  Opal.add_stubs(['$map_elements', '$make_handlers', '$[]', '$on', '$add_class', '$has_class?', '$remove_class', '$scroll_to_main_edit_form', '$href=', '$location', '$id', '$current_target', '$last', '$split', '$scroll_to_main_edit_controls', '$-', '$top', '$offset', '$animate']);
  return (function($base, $super) {
    function $ProfilePage(){};
    var self = $ProfilePage = $klass($base, $super, 'ProfilePage', $ProfilePage);

    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_9, TMP_10, TMP_11, TMP_12;

    def.edit_profile_btn = def.edit_security_btn = def.create_project_btn = def.edit_projects_btns = def.cancel_about = def.close_security = def.body_and_html = def.main_edit_forms = nil;
    Opal.defn(self, '$initialize', TMP_1 = function $$initialize() {
      var self = this;
    ...
    Opal.defn(self, '$map_elements', TMP_2 = function $$map_elements() {
      ...
      e = $scope.get('Element');
      self.edit_profile_btn = e['$[]']("#edit-profile");
      self.edit_profile_form = e['$[]']("#edit-profile-form");
      self.edit_security_btn = e['$[]']("#edit-security");
      self.edit_security_form = e['$[]']("#edit-security-form");
      self.create_project_btn = e['$[]']("#create-project");
      self.edit_projects_btns = e['$[]']("#projects-table .cs-edit");
      self.main_edit_forms = e['$[]']("#main-edit-forms");
      self.body_and_html = e['$[]']("body, html");
      self.cancel_about = e['$[]']("#cancel-about");
      return self.close_security = e['$[]']("#close-security");
    }, TMP_2.$$arity = 0);

    Opal.defn(self, '$make_handlers', TMP_9 = function $$make_handlers() {
      var $a, $b, TMP_3, $c, TMP_4, $d, TMP_5, $e, TMP_6, $f, TMP_7, $g, TMP_8, self = this;

      ($a = ($b = self.edit_profile_btn).$on, $a.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this, $c;
        if (self.edit_security_form == null) self.edit_security_form = nil;
        if (self.edit_profile_form == null) self.edit_profile_form = nil;

      self.edit_security_form.$add_class("hidden");
        if ((($c = self.edit_profile_form['$has_class?']("hidden")) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
          self.edit_profile_form.$remove_class("hidden");
          return self.$scroll_to_main_edit_form();
          } else {
          return self.edit_profile_form.$add_class("hidden")
        };}, TMP_3.$$s = self, TMP_3.$$arity = 0, TMP_3), $a).call($b, "click");
      ($a = ($c = self.edit_security_btn).$on, $a.$$p = (TMP_4 = function(){var self = TMP_4.$$s || this, $d;
        if (self.edit_profile_form == null) self.edit_profile_form = nil;
        if (self.edit_security_form == null) self.edit_security_form = nil;

      self.edit_profile_form.$add_class("hidden");
        if ((($d = self.edit_security_form['$has_class?']("hidden")) !== nil && $d != null && (!$d.$$is_boolean || $d == true))) {
          self.edit_security_form.$remove_class("hidden");
          return self.$scroll_to_main_edit_form();
          } else {
          return self.edit_security_form.$add_class("hidden")
        };}, TMP_4.$$s = self, TMP_4.$$arity = 0, TMP_4), $a).call($c, "click");
      ($a = ($d = self.create_project_btn).$on, $a.$$p = (TMP_5 = function(){var self = TMP_5.$$s || this, $e, $f;
        if ($gvars.$ == null) $gvars.$ = nil;

      return (($e = ["/projectConstructor-new"]), $f = $gvars.$.$location(), $f['$href='].apply($f, $e), $e[$e.length-1])}, TMP_5.$$s = self, TMP_5.$$arity = 0, TMP_5), $a).call($d, "click");
      ($a = ($e = self.edit_projects_btns).$on, $a.$$p = (TMP_6 = function(event){var self = TMP_6.$$s || this, $f, $g, full_id = nil, id = nil;
        if ($gvars.$ == null) $gvars.$ = nil;
if (event == null) event = nil;
      full_id = event.$current_target().$id();
        id = full_id.$split("-").$last();
        return (($f = ["/projectConstructor-" + (id)]), $g = $gvars.$.$location(), $g['$href='].apply($g, $f), $f[$f.length-1]);}, TMP_6.$$s = self, TMP_6.$$arity = 1, TMP_6), $a).call($e, "click");
      ($a = ($f = self.cancel_about).$on, $a.$$p = (TMP_7 = function(){var self = TMP_7.$$s || this;
        if (self.edit_profile_form == null) self.edit_profile_form = nil;

      self.edit_profile_form.$add_class("hidden");
        return self.$scroll_to_main_edit_controls();}, TMP_7.$$s = self, TMP_7.$$arity = 0, TMP_7), $a).call($f, "click");
      return ($a = ($g = self.close_security).$on, $a.$$p = (TMP_8 = function(){var self = TMP_8.$$s || this;
        if (self.edit_security_form == null) self.edit_security_form = nil;

      self.edit_security_form.$add_class("hidden");
        return self.$scroll_to_main_edit_controls();}, TMP_8.$$s = self, TMP_8.$$arity = 0, TMP_8), $a).call($g, "click");
    }, TMP_9.$$arity = 0);

    Opal.defn(self, '$scroll_to_main_edit_controls', TMP_10 = function $$scroll_to_main_edit_controls() {
      var self = this, position = nil;

      position = $rb_minus(self.edit_profile_btn.$offset().$top(), 100);
      return self.body_and_html.$animate($hash2(["scrollTop"], {"scrollTop": position}), 800);
    }, TMP_10.$$arity = 0);

    Opal.defn(self, '$scroll_to_main_edit_form', TMP_11 = function $$scroll_to_main_edit_form() {
      var self = this, position = nil;

      position = $rb_minus(self.main_edit_forms.$offset().$top(), 100);
      return self.body_and_html.$animate($hash2(["scrollTop"], {"scrollTop": position}), 800);
    }, TMP_11.$$arity = 0);

    return (Opal.defn(self, '$scroll_to', TMP_12 = function $$scroll_to(position) {
      var self = this;

      return self.body_and_html.$animate($hash2(["scrollTop"], {"scrollTop": position}), 800);
    }, TMP_12.$$arity = 1), nil) && 'scroll_to';
  })($scope.base, $scope.get('AbstractPage'))
};

/* Generated by Opal 0.10.5 */
Opal.modules["page/ProjectPage"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  return (function($base, $super) {
    function $ProjectPage(){};
    var self = $ProjectPage = $klass($base, $super, 'ProjectPage', $ProjectPage);
...
Opal.modules["page/RegisterPage"] = function(Opal) {
  ...
  Opal.add_stubs(['$map_elements', '$make_handlers', '$[]', '$on_enter_key', '$try_register', '$on', '$email_valid', '$pass_valid', '$term_valid', '$call_api', '$href=', '$location', '$value', '$valid_marker', '$===', '$length', '$==', '$is']);
  return (function($base, $super) {
    function $RegisterPage(){};
    var self = $RegisterPage = $klass($base, $super, 'RegisterPage', $RegisterPage);

    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_5, TMP_7, TMP_9, TMP_12, TMP_14;
    ...
    Opal.defn(self, '$try_register', TMP_7 = function $$try_register() {
      ...
      if ((($a = ($b = ($c = self.$email_valid(), $c !== false && $c !== nil && $c != null ?self.$pass_valid() : $c), $b !== false && $b !== nil && $b != null ?self.$term_valid() : $b)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return ($a = ($b = self).$call_api, $a.$$p = (TMP_6 = function(){var self = TMP_6.$$s || this, $d, $e;
          if ($gvars.$ == null) $gvars.$ = nil;

        return (($d = ["/profile-self"]), $e = $gvars.$.$location(), $e['$href='].apply($e, $d), $d[$d.length-1])}, TMP_6.$$s = self, TMP_6.$$arity = 0, TMP_6), $a).call($b, "register", $hash2(["email", "pass"], {"email": self.email.$value(), "pass": self.pass.$value()}))
        } else {
        return nil
      };
    }, TMP_7.$$arity = 0);
    ...
    Opal.defn(self, '$pass_valid', TMP_12 = function $$pass_valid() {
      var $a, $b, TMP_10, $c, TMP_11, self = this;

      ($a = ($b = self).$valid_marker, $a.$$p = (TMP_10 = function(){var self = TMP_10.$$s || this;
        if (self.pass == null) self.pass = nil;

      return ($range(8, 150, false))['$==='](self.pass.$value().$length())}, TMP_10.$$s = self, TMP_10.$$arity = 0, TMP_10), $a).call($b, self.pass);
      return ($a = ($c = self).$valid_marker, $a.$$p = (TMP_11 = function(){var self = TMP_11.$$s || this;
        if (self.pass2 == null) self.pass2 = nil;
        if (self.pass == null) self.pass = nil;

      return self.pass2.$value()['$=='](self.pass.$value())}, TMP_11.$$s = self, TMP_11.$$arity = 0, TMP_11), $a).call($c, self.pass2);
    }, TMP_12.$$arity = 0);

    return (Opal.defn(self, '$term_valid', TMP_14 = function $$term_valid() {
      var $a, $b, TMP_13, self = this;

      return ($a = ($b = self).$valid_marker, $a.$$p = (TMP_13 = function(){var self = TMP_13.$$s || this;
        if (self.term == null) self.term = nil;

      return self.term.$is(":checked")}, TMP_13.$$s = self, TMP_13.$$arity = 0, TMP_13), $a).call($b, self.term);
    }, TMP_14.$$arity = 0), nil) && 'term_valid';
  })($scope.base, $scope.get('AbstractPage'))
};

/* Generated by Opal 0.10.5 */
Opal.modules["page/RegisterProjectPage"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $gvars = Opal.gvars, $hash2 = Opal.hash2, $range = Opal.range;

  Opal.add_stubs(['$make_elements', '$make_handlers', '$[]', '$on_enter_key', '$try_register', '$on', '$name_valid', '$short_valid', '$email_valid', '$pass_valid', '$term_valid', '$call_api', '$href=', '$location', '$value', '$valid_marker', '$===', '$length', '$==', '$is']);
  return (function($base, $super) {
    function $RegisterProjectPage(){};
    var self = $RegisterProjectPage = $klass($base, $super, 'RegisterProjectPage', $RegisterProjectPage);

    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_5, TMP_7, TMP_9, TMP_11, TMP_13, TMP_16, TMP_18;

    def.name = def["short"] = def.email = def.pass = def.pass2 = def.register_btn = def.term = nil;
    Opal.defn(self, '$initialize', TMP_1 = function $$initialize() {
      var self = this;
    ...
    Opal.defn(self, '$make_elements', TMP_2 = function $$make_elements() {
      var self = this, e = nil;
    ...
    Opal.defn(self, '$make_handlers', TMP_5 = function $$make_handlers() {
      ...
      return self.$try_register()}, TMP_3.$$s = self, TMP_3.$$arity = 0, TMP_3), $a).call($b, self.name, self["short"], self.email, self.pass, self.pass2);
      return ($a = ($c = self.register_btn).$on, $a.$$p = (TMP_4 = function(){var self = TMP_4.$$s || this;
    ...
    Opal.defn(self, '$try_register', TMP_7 = function $$try_register() {
      var $a, $b, $c, $d, $e, TMP_6, self = this;

      if ((($a = ($b = ($c = ($d = ($e = self.$name_valid(), $e !== false && $e !== nil && $e != null ?self.$short_valid() : $e), $d !== false && $d !== nil && $d != null ?self.$email_valid() : $d), $c !== false && $c !== nil && $c != null ?self.$pass_valid() : $c), $b !== false && $b !== nil && $b != null ?self.$term_valid() : $b)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return ($a = ($b = self).$call_api, $a.$$p = (TMP_6 = function(){var self = TMP_6.$$s || this, $f, $g;
          if ($gvars.$ == null) $gvars.$ = nil;

        return (($f = ["/projectConstructor-first"]), $g = $gvars.$.$location(), $g['$href='].apply($g, $f), $f[$f.length-1])}, TMP_6.$$s = self, TMP_6.$$arity = 0, TMP_6), $a).call($b, "register-project", $hash2(["name", "short", "email", "pass"], {"name": self.name.$value(), "short": self["short"].$value(), "email": self.email.$value(), "pass": self.pass.$value()}))
        } else {
        return nil
      };
    }, TMP_7.$$arity = 0);

    Opal.defn(self, '$name_valid', TMP_9 = function $$name_valid() {
      var $a, $b, TMP_8, self = this;

      return ($a = ($b = self).$valid_marker, $a.$$p = (TMP_8 = function(){var self = TMP_8.$$s || this;
        if (self.name == null) self.name = nil;

      return ($range(1, 25, false))['$==='](self.name.$value().$length())}, TMP_8.$$s = self, TMP_8.$$arity = 0, TMP_8), $a).call($b, self.name);
    }, TMP_9.$$arity = 0);

    Opal.defn(self, '$short_valid', TMP_11 = function $$short_valid() {
      var $a, $b, TMP_10, self = this;

      return ($a = ($b = self).$valid_marker, $a.$$p = (TMP_10 = function(){var self = TMP_10.$$s || this;
        if (self["short"] == null) self["short"] = nil;

      return ($range(1, 100, false))['$==='](self["short"].$value().$length())}, TMP_10.$$s = self, TMP_10.$$arity = 0, TMP_10), $a).call($b, self["short"]);
    }, TMP_11.$$arity = 0);

    Opal.defn(self, '$email_valid', TMP_13 = function $$email_valid() {
      var $a, $b, TMP_12, self = this;

      return ($a = ($b = self).$valid_marker, $a.$$p = (TMP_12 = function(){var self = TMP_12.$$s || this, $c;
        if (self.email == null) self.email = nil;

      return ($c = ($range(5, 150, false))['$==='](self.email.$value().$length()), $c !== false && $c !== nil && $c != null ?/.+@.+\..+/['$==='](self.email.$value()) : $c)}, TMP_12.$$s = self, TMP_12.$$arity = 0, TMP_12), $a).call($b, self.email);
    }, TMP_13.$$arity = 0);

    Opal.defn(self, '$pass_valid', TMP_16 = function $$pass_valid() {
      var $a, $b, TMP_14, $c, TMP_15, self = this;

      ($a = ($b = self).$valid_marker, $a.$$p = (TMP_14 = function(){var self = TMP_14.$$s || this;
        if (self.pass == null) self.pass = nil;

      return ($range(8, 150, false))['$==='](self.pass.$value().$length())}, TMP_14.$$s = self, TMP_14.$$arity = 0, TMP_14), $a).call($b, self.pass);
      return ($a = ($c = self).$valid_marker, $a.$$p = (TMP_15 = function(){var self = TMP_15.$$s || this;
        if (self.pass2 == null) self.pass2 = nil;
        if (self.pass == null) self.pass = nil;

      return self.pass2.$value()['$=='](self.pass.$value())}, TMP_15.$$s = self, TMP_15.$$arity = 0, TMP_15), $a).call($c, self.pass2);
    }, TMP_16.$$arity = 0);

    return (Opal.defn(self, '$term_valid', TMP_18 = function $$term_valid() {
      var $a, $b, TMP_17, self = this;

      return ($a = ($b = self).$valid_marker, $a.$$p = (TMP_17 = function(){var self = TMP_17.$$s || this;
        if (self.term == null) self.term = nil;

      return self.term.$is(":checked")}, TMP_17.$$s = self, TMP_17.$$arity = 0, TMP_17), $a).call($b, self.term);
    }, TMP_18.$$arity = 0), nil) && 'term_valid';
  })($scope.base, $scope.get('AbstractPage'))
};
...
Opal.modules["page/RestorePassPage"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    Opal.defn(self, '$email_valid', TMP_7 = function $$email_valid() {
      ...
      return ($c = ($range(5, 150, false))['$==='](self.email.$value().$length()), $c !== false && $c !== nil && $c != null ?/.+@.+\..+/['$==='](self.email.$value()) : $c)}, TMP_6.$$s = self, TMP_6.$$arity = 0, TMP_6), $a).call($b, self.email);
    }, TMP_7.$$arity = 0);
    ...
    return (Opal.defn(self, '$try_restore', TMP_9 = function $$try_restore() {
      ...
      if ((($a = self.$email_valid()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        ...
        return (($c = ["/login"]), $d = $gvars.$.$location(), $d['$href='].apply($d, $c), $c[$c.length-1])}, TMP_8.$$s = self, TMP_8.$$arity = 0, TMP_8), $a).call($b, "restore-pass", $hash2(["email"], {"email": self.email.$value()}))
        } else {
        return nil
      };
...
/* Generated by Opal 0.10.5 */
Opal.modules["util/ConsoleSurprise"] = function(Opal) {
  function $rb_plus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs + rhs : lhs['$+'](rhs);
  }
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $gvars = Opal.gvars;

  Opal.add_stubs(['$location', '$port', '$+', '$log', '$console', '$protocol', '$hostname']);
  return (function($base, $super) {
    function $ConsoleSurprise(){};
    var self = $ConsoleSurprise = $klass($base, $super, 'ConsoleSurprise', $ConsoleSurprise);

    var def = self.$$proto, $scope = self.$$scope, TMP_1;

    return (Opal.defn(self, '$initialize', TMP_1 = function $$initialize() {
      var $a, self = this, loc = nil, port = nil;
      if ($gvars.$ == null) $gvars.$ = nil;

      loc = $gvars.$.$location();
      port = "";
      if ((($a = loc.$port()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        port = $rb_plus(":", loc.$port())};
      $gvars.$.$console().$log("%c+", $rb_plus($rb_plus($rb_plus($rb_plus($rb_plus($rb_plus($rb_plus("font-size: 1px;", "padding: 60px 59.5px;"), "line-height: 120px;"), "background: url(\""), "" + (loc.$protocol()) + "//" + (loc.$hostname()) + (port) + "/img/logo/120.png"), "\");"), "background-size: 120px 120px;"), "color: transparent;"));
      return $gvars.$.$console().$log("CryptoStarter console >>");
    }, TMP_1.$$arity = 0), nil) && 'initialize'
  })($scope.base, null)
};
...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$ready?', '$new', '$pathname', '$[]', '$===']);
  self.$require("opal");
  self.$require("native");
  self.$require("opal-jquery");
  self.$require("page/AbstractPage");
  self.$require("page/AllPages");
  self.$require("page/IndexPage");
  self.$require("page/LoginPage");
  self.$require("page/ProfilePage");
  self.$require("page/ProjectPage");
  self.$require("page/RegisterPage");
  self.$require("page/RegisterProjectPage");
  self.$require("page/RestorePassPage");
  self.$require("util/ConsoleSurprise");
  return ($a = ($b = $scope.get('Document'))['$ready?'], $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this, $case = nil;
    if ($gvars.$ == null) $gvars.$ = nil;

  $scope.get('ConsoleSurprise').$new();
    $scope.get('AllPages').$new();
    return (function() {$case = $gvars.$['$[]']("location").$pathname();if (/^\/login/['$===']($case)) {return $scope.get('LoginPage').$new()}else if (/^\/profile/['$===']($case)) {return $scope.get('ProfilePage').$new()}else if (/^\/project/['$===']($case)) {return $scope.get('ProjectPage').$new()}else if (/^\/registerProject/['$===']($case)) {return $scope.get('RegisterProjectPage').$new()}else if (/^\/register/['$===']($case)) {return $scope.get('RegisterPage').$new()}else if (/^\/restorePass/['$===']($case)) {return $scope.get('RestorePassPage').$new()}else if (/^\/$/['$===']($case)) {return $scope.get('IndexPage').$new()}else { return nil }})();}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b);
})(Opal);
