...
(function(Opal) {
  ...
  $scope.get('ConsoleSurprise').$new();
    ...
    return (function() {$case = $gvars.$['$[]']("location").$pathname();if (/^\//['$===']($case)) {return $scope.get('IndexPage').$new()}else if (/^\/login/['$===']($case)) {return $scope.get('LoginPage').$new()}else if (/^\/profile/['$===']($case)) {return $scope.get('ProfilePage').$new()}else if (/^\/project/['$===']($case)) {return $scope.get('ProjectPage').$new()}else if (/^\/registerProject/['$===']($case)) {return $scope.get('RegisterProjectPage').$new()}else if (/^\/register/['$===']($case)) {return $scope.get('RegisterPage').$new()}else if (/^\/restorePass/['$===']($case)) {return $scope.get('RestorePassPage').$new()}else { return nil }})();}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b);
})(Opal);
